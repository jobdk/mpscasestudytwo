...
public class ClassEntity_DeleteBodyActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        ...
        SPropertyOperations.set(node, PROPS.showBody$h_gs, false);
        ListSequence.fromList(SLinkOperations.getChildren(node, LINKS.elements$e2ol)).clear();
        SelectionUtil.selectLabelCellAnSetCaret(editorContext, node, "classEntityNameId", -1);
      }
      @Override
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return SPropertyOperations.getBoolean(node, PROPS.showBody$h_gs);
      }
