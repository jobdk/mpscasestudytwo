...
public class DependencyDeleteLabelActionMap {
  ...
  /*package*/ static AbstractCellAction createAction_DELETE(final SNode node) {
    return new AbstractCellAction() {
      ...
      public void execute_internal(EditorContext editorContext, SNode node) {
        if (DeletionApproverUtil.approve(editorContext, node, "labelContainerId")) {
          return;
        }
        SPropertyOperations.set(node, PROPS.showLabel$uAQU, false);
        SPropertyOperations.set(node, PROPS.label$_iEv, "");
      ...
      public boolean canExecute_internal(EditorContext editorContext, SNode node) {
        return SPropertyOperations.getBoolean(node, PROPS.showLabel$uAQU);
      }
